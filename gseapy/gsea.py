...
class GSEA(GSEAbase):
    ...
    def run(self):
        ...
        gsea_results, es, esnull, nEnrichmentNulls, hit_ind, rank_ES, subsets = gsea_compute_tensor(data=dataset, gmt=gmt, n=self.permutation_num,
        ...
        gsea_results_scores = gsea_results[0]
        self._logger.info("Start to generate GSEApy reports and figures............")
        res_zip = zip(subsets, list(gsea_results_scores), hit_ind, rank_ES)
        ...
        return gsea_results[1], gsea_results[2], gsea_results[3]
